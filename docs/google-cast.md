...
`https://naijafeud.kayodeadetunji.com/cast/receiver`.
...
2. Add a **Custom Receiver** application named **Naija Family Showdown**.
3. Set the receiver URL to `https://naijafeud.kayodeadetunji.com/cast/receiver`.
...
6. Refresh the host dashboard in desktop Chrome, with the computer and TV on the same
   Wi-Fi, and click **Cast to TV**. Choose a Google Cast-compatible display.
...
- Game sound effects currently remain on the host device.
